...
#from web_app.services.basilica_service import basilica_api as basilica_connection
import web_app.services.basilica_service as basilica_connection
...
def predict():
    ...
    example_embedding = basilica_connection.basilica_api().embed_sentence(tweet_text, model="twitter")
